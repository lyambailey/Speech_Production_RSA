...
% The purpose of this script is to (1) get correlations between exemplar
% hypothesis models (which contain all stimuli, and therefore are identical
% for all participants), and (2) visualize dissimilarity matrics for each
% hypothesis model, from one participant and conition
...
%% (1) Compute between-model correlation matrix
